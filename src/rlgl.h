...
void rlVertex3f(float x, float y, float z)
{
    ...
    _mm_prefetch((const char *)(RLGL.currentBatch->vertexBuffer + RLGL.currentBatch->currentBuffer), 1);
    _mm_prefetch((const char *)(RLGL.currentBatch->draws + RLGL.currentBatch->drawCounter - 1), 0);
#endif

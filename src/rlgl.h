 ...
 *OpenGL version is required by any other module, use rlGetVersion() to check it
 *
...
void rlVertex3f(float x, float y, float z) {
  ...
  _mm_prefetch((const char *)(RLGL.currentBatch->vertexBuffer +
                              RLGL.currentBatch->currentBuffer),
               1);
  _mm_prefetch((const char *)(RLGL.currentBatch->draws +
